...
int main(void){
    sim_puts("BEXTI test\n");
    int fail = 0;
    CHECK_CASE_IMM(1, 0x00000000u,  0, 0x00000000u);
    CHECK_CASE_IMM(2, 0x00000002u,  0, 0x00000000u);
    CHECK_CASE_IMM(3, 0x00000001u,  0, 0x00000001u);
    CHECK_CASE_IMM(4, 0x80000000u, 31, 0x00000001u);
    CHECK_CASE_IMM(5, 0x7FFFFFFFu, 31, 0x00000000u);
