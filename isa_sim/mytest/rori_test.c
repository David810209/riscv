...
int main(void){
    sim_puts("RORI test\n");
    int fail = 0;
    CHECK_CASE_IMM(1, 0x00000001u,  0, 0x00000001u);
    CHECK_CASE_IMM(2, 0x00000001u,  1, 0x80000000u);
    CHECK_CASE_IMM(3, 0x00000001u,  7, 0x02000000u);
    CHECK_CASE_IMM(4, 0x00000001u, 14, 0x00040000u);
    CHECK_CASE_IMM(5, 0x00000001u, 31, 0x00000002u);
    CHECK_CASE_IMM(6, 0xFFFFFFFFu,  7, 0xFFFFFFFFu);
    CHECK_CASE_IMM(7, 0x21212121u,  1, 0x90909090u);
    CHECK_CASE_IMM(8, 0x21212121u,  7, 0x42424242u);
    CHECK_CASE_IMM(9, 0x12345678u,  4, 0x81234567u);
