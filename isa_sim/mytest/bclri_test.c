...
int main(void){
    sim_puts("BCLRI test\n");
    int fail = 0;
    CHECK_CASE_IMM(1, 0x00000020u,  5, 0x00000000u);
    CHECK_CASE_IMM(2, 0x00000101u,  0, 0x00000100u);
    CHECK_CASE_IMM(3, 0x00000009u,  3, 0x00000001u);
    CHECK_CASE_IMM(4, 0x00000011u,  4, 0x00000001u);
    CHECK_CASE_IMM(5, 0x00000101u,  8, 0x00000001u);
